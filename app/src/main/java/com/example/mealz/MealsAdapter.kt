...
import com.example.mealz.databinding.CategoriesItemBinding

class MealsAdapter(): ListAdapter<Category, MealsAdapter.ViewHolder>(CategoryDiffCallback()){

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val itemBinding= CategoriesItemBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    class ViewHolder(private val itemBinding: CategoriesItemBinding) : RecyclerView.ViewHolder(itemBinding.root) {
